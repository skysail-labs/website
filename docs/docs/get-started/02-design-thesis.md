...
- [Trade Flow](../how-it-works/trade-flow) follows one order end to end.
- [Privacy & Attestation](../how-it-works/privacy-and-attestation) explains how
  clients verify the confidential matcher.
- [Programmatic Access](./programmatic-access) maps the integration surface.
