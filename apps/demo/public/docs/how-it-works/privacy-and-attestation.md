...
| **Trader privacy** | The link from a trade to your wallet | You sign with a **trading key**, not your wallet. The wallet-to-trade link exists only inside your own withdraw proof. |
