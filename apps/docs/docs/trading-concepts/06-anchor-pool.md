...
description: How a partially-filled order keeps working, using pre-supplied continuation anchors that let the engine re-lock the remainder without a round-trip.
---
