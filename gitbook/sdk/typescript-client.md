...
signed viewing key, and the current boot session (see [Place Order](../orders/place-order.md)). The SDK
...
[`/v1/stream` session](../websocket/session-stream.md) instead of REST, using one warm connection plus
