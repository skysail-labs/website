...
sidebar_position: 1
title: Overview
description: Darknyx is a privacy-preserving spot darkpool on Solana, with hidden orders matched inside an attested confidential VM and settled trustlessly with zero-knowledge proofs.
---
